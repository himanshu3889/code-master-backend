module github.com/himanshu3889/code-master-backend
...
require (
	...
	github.com/gin-gonic/gin v1.12.0 // HTTP/WebSocket router
	...
	golang.org/x/crypto v0.48.0 // CRYPTO
)
...
require (
	github.com/culionbear/lokirus v1.0.5
